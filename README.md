...
* [VS Code](https://code.visualstudio.com/) [![VS Code][awesome]](https://github.com/viatsko/awesome-vscode) ⭐ 28,667 | 🐛 87 | 🌐 JavaScript | 📅 2024-06-21 ![foss]
  * [LaTeX Workshop](https://github.com/James-Yu/LaTeX-Workshop) ⭐ 11,948 | 🐛 7 | 🌐 TypeScript | 📅 2026-03-27 - LaTeX extension for Visual Studio Code ![foss]
...
* [WebLaTeX](https://github.com/sanjib-sen/weblatex) ⭐ 1,664 | 🐛 16 | 🌐 TeX | 📅 2024-05-23 - Web-based vscode with Git Integration + Copilot + Grammar & Spell Checker + Live Collaboration Support based on GitHub Codespace and Dev container.
...
* [Papis](https://github.com/papis/papis) ⭐ 1,672 | 🐛 113 | 🌐 HTML | 📅 2026-03-23 - Extremely customizable,
  ...
  ![linux] ![mac] ![foss]
* [betterbib](https://github.com/nschloe/betterbib) ⭐ 836 | 🐛 3 | 📅 2025-04-08 - Command-line utility for improving your BibTeX files. Fetches information from online sources. ![mac] ![windows] ![linux] ![foss]
